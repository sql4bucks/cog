...
<html>
	...
	<body>
		<a href="#edit-locationDetail" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-locationDetail" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${locationDetailInstance?.version}" />
				<fieldset class="form">
