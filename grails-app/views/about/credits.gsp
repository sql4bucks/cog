...
<html>
	<head>
		...
		<link rel="canonical" href="http://churchofgodportland.org/about/credits" />
		<style type="text/css">
		 p {
	...
	<body>
		...
		<section id="page-body" role="main" class="content scaffold-show">
			...
			<article id="credits">
			<p>
			This section "gives credit where credit is due". This web site has benefited from the works of many individuals.
			A web site is not complete without some stellar images. I'm no graphic designer, so I have to use the work of
			others to dress up the place. Most of the images on this site are used based on the
			 <g:link url="http://creativecommons.org/licenses/by/3.0/" target="_blank">CC Attribution 3.0 license </g:link>
			or by permission from the artist. These artists do amazing work, and we want to acknowledge their contributions here.
			</p>
			 <table>
			 <colgroup span="3">
			 	<col width="20%">
			 ...
			 <tr>
			 	...
			 	<td>	
			 		...
			 		His painting <g:link url="http://www.inspired-art.com/gallery_3/welcome_home.html" target="_blank"><em>Welcome Home</em></g:link> graces every
