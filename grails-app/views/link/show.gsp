	...
	<body>
		...
		<div id="show-link" class="content scaffold-show" role="main">
			...
			<ol class="property-list link">
				...
				<g:if test="${linkInstance?.sortOrder}">
				<li class="fieldcontain">
					<span id="sortOrder-label" class="property-label"><g:message code="link.sortOrder.label" default="Sort Order" /></span>
					
						<span class="property-value" aria-labelledby="sortOrder-label"><g:fieldValue bean="${linkInstance}" field="sortOrder"/></span>
