	...
	<body>
		...
		<div id="show-city" class="content scaffold-show" role="main">
			...
			<ol class="property-list city">
				...
				<g:if test="${cityInstance?.description}">
				<li class="fieldcontain">
					<span id="description-label" class="property-label"><g:message code="city.description.label" default="Description" /></span>
					
						<span class="property-value" aria-labelledby="description-label"><g:fieldValue bean="${cityInstance}" field="description"/></span>
