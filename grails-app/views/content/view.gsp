...
<html>
	...
	<body>
		...
		<div class="marginLeft">
			<a class="large button2 purple download noSpin" href="/cog/content/file/${contentInstance.id}">
				Download
			</a>
		...
		<div class="contentContainer marginLeft">
			<div class="contentRightPane"></div>
			<div id="mediaPlayer" class="mediaContent">
				<div class="contentHolderRight marginLeft">
				 	<h2>Live Streaming Player</h2>
				 	<div class="floatLeft marginLeft  marginTop">
					...
					<div class="contentHolderLeft">
						<h2>Instructions</h2>
						<p>
						Use media player on right to play the content on-line.
						</p>
						<p>Notes about player</p>
						<ul>
							<li> Use controls to play and pause</li>
							<li> Click progress bar to advance or rewind </li>
							<li> Click volume range bar to adjust volume</li>
							<li> Mute volume - click the ""mute" button </li>  
						</ul>
					</div>
				</div>
			</div>
