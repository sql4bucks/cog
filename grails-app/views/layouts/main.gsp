...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"><!--<![endif]-->
	<head>
		...
		<meta name="keywords" content="Church,God,Jesus,preaching,hymns,sermons,recordings,audio,downloads,heaven,hell,Evening Light,spiritual,Portland,salvation,Jesus,Christianity,meaning of life" />
